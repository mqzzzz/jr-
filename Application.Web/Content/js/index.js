...
function AnQuan() {
                ...
                if (result.code === 200) {
                    for (var i = 0; i < result.data.length; i++) {
                        arr.push({
                            ...
                            name: result.data[i].DIP_name
                        });
                        arr2.push({ name: result.data[i].DIP_name });
                    }
            ...
            success: function (result) {
                if (result.code === 200) {
                    for (var i = 0; i < result.data.length; i++) {
                        arr.push({
                            value: result.data[i].total,
                            name: result.data[i].Seed_name
                        });
                        arr2.push({ name: result.data[i].Seed_name });
                    }
    ...
    $(function () {
        ...
        $.ajax({
            async: false,
            type: 'GET',
            url: "/Chart/GetZhengDiChart",
            dataType: "json",
            success: function (result) {
                if (result.code === 200) {
                    for (var i = 0; i < result.data.length; i++) {
                        arr.push(result.data[i].total);
                        arr2.push(result.data[i].Landrectification_name);
                    }
